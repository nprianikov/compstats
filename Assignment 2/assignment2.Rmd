...
fixed_p_values_1 <- replicate(100, conditional_randomization_test(X, Y, 1, K=20))
hist(fixed_p_values_1)
```
...
prob <- plogis(0.08 * rowSums(X[, 2:22]))
Y <- rbinom(n, 1, prob)
fixed_p_values_2 <- replicate(100, conditional_randomization_test(X, Y, 1, K=20))
hist(fixed_p_values_2)
```
